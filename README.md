...
![4688 Event](process-creation-event-4688.png)

### Windows Event Log Cleared Event (Event ID 1102)

Windows Security Event ID 1102 was generated after clearing the Security event log.

![1102 Event](event-log-cleared-1102.png)

### Elastic Security Detection Alert

Elastic Security successfully detected the suspicious activity and generated an alert.

![Detection Alert](windows-event-log-alert.png)
---
